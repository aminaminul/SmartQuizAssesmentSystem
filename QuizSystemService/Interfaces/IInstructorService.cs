...
namespace QuizSystemService.Interfaces
{
    ...
    {
        Task<List<Instructor>> GetAllAsync(long? educationMediumId = null, long? classId = null, long? subjectId = null);
        ...
        Task<bool> UpdateAsync(long id, Instructor model, long? educationMediumId, long? classId, long? subjectId = null);
        ...
        Task<List<Subject>> GetSubjectsAsync(long? classId = null);
